...
# 🔴➖➖➖➖ START OF COMMENT OUT______________________ 
# (Opening MS Word 365 is deactivated here, avoid opening many instances every time the script is run)
...
# 🔴➖➖➖➖ END OF COMMENT OUT______________________
